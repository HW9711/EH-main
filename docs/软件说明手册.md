...
编制基线：`R1` 分支，`667bf66f633babd14396b12f02b145f199bbf7a6`
...
| 5 | 电机过载兼容 | 驱动 Err 2/5 | 是 | UI 过载，蜂鸣，外控报警 | 非脚踏来源按原规则清除；脚踏来源必须驱动恢复且当前脚踏已松开 |
...
| 电机驱动 Err | UART1 回包 Err 非 0 | 是 | 脚踏来源由25ms任务锁存停机；恢复帧再执行全停 | A泵立即直发0，A/B `run_flag=false` | 显示映射报警 | 普通故障至少3秒；脚踏过载等待Err恢复且当前松脚 | 独立报警变化帧上传 |
